...
export default function FileSelectorScreen({ openOsmFile }: FileSelectorScreenProps) {
  return (
    <div className="bg-slate-50 overflow-y-scroll w-full h-full">
      <div className="flex flex-col gap-8 max-w-xl py-20 my-auto mx-auto">
        ...
        <p className="text-center text-muted-foreground ">Select an OSM file to get started.</p>
