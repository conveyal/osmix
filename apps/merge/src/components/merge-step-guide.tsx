...
export const MERGE_STEP_GUIDES = {
  ...
  "review-intersections": {
    ...
    mutations: [
      "Applying can reuse a compatible node, update every way connected to the replaced endpoint and every affected restriction via-node together, merge non-conflicting node tags, and add crossing=yes.",
      "If reuse would collapse a way, a new exact crossing node is possible only for an isolated endpoint with no affected restriction; an unsafe shared-junction change is skipped.",
    ],
    invariants: [
      "New grade-separated interior crossings remain disconnected; existing bridge and tunnel entrances stay connected.",
      "Node reuse cannot collapse any incident way. Unsafe shared-junction changes preserve the original references and restriction members.",
  ...
  intersections: {
    ...
    mutations: [
      "The generated changeset can reuse a compatible nearby node, update every way connected to the replaced endpoint and every affected restriction via-node together, merge non-conflicting node tags, and add crossing=yes.",
      "If reuse would collapse a way, a new exact crossing node is possible only for an isolated endpoint with no affected restriction; an unsafe shared-junction change is skipped.",
      "No intersection edits are applied until the following review screen.",
    ],
    invariants: [
      "New grade-separated interior crossings remain disconnected; existing bridge and tunnel entrances stay connected.",
      "A nearby endpoint is reused only when every incident way, affected restriction, and grade connection remains valid.",
