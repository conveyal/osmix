...
function nearestNeighbor(osm: Osm, lon: number, lat: number, count: number): OsmNode[] {
...
function exportWaysGeoJSON(osm: Osm, limit = Number.POSITIVE_INFINITY): GeoJSON.FeatureCollection {
