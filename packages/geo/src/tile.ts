 ...
 */
export function bboxToTilePx(bbox: GeoBbox2D, tile: Tile, tileSize = 256): TilePxBbox {
 ...
 */
export function clampAndRoundPx(px: XY, tileSizeOrBbox: number | GeoBbox2D): XY {
  const [minX, minY, maxX, maxY] =
    typeof tileSizeOrBbox === "number" ? [0, 0, tileSizeOrBbox, tileSizeOrBbox] : tileSizeOrBbox;
  return [
