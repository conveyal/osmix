...
export function readHeaderBBox(pbf: Pbf, end?: number): OsmPbfHeaderBBox {
	return pbf.readFields(
		readHeaderBBoxField,
...
export function writeHeaderBBox(obj: OsmPbfHeaderBBox, pbf: Pbf) {
...
export function readPrimitiveGroup(
	pbf: Pbf,
	end?: number,
...
export function readStringTable(pbf: Pbf, end?: number): OsmPbfStringTable {
...
export function writeStringTable(obj: OsmPbfStringTable, pbf: Pbf) {
	if (obj.s) {
		for (const item of obj.s) pbf.writeBytesField(1, item)
	}
}

export function readInfo(pbf: Pbf, end?: number): OsmPbfInfo {
...
export function writeInfo(obj: OsmPbfInfo, pbf: Pbf) {
...
export function readDenseInfo(pbf: Pbf, end?: number): OsmPbfDenseInfo {
	return pbf.readFields(
		readDenseInfoField,
		{
			version: [],
...
export function writeDenseInfo(obj: OsmPbfDenseInfo, pbf: Pbf) {
...
export function writeNode(obj: OsmPbfNode, pbf: Pbf) {
...
export function readDenseNodes(pbf: Pbf, end?: number): OsmPbfDenseNodes {
	return pbf.readFields(
		readDenseNodesField,
...
export function writeDenseNodes(obj: OsmPbfDenseNodes, pbf: Pbf) {
...
export function readWay(pbf: Pbf, end?: number): OsmPbfWay {
	return pbf.readFields(
		readWayField,
...
export function writeRelation(obj: OsmPbfRelation, pbf: Pbf) {
	if (obj.id) pbf.writeVarintField(1, obj.id)
	if (obj.keys) pbf.writePackedVarint(2, obj.keys)
	if (obj.vals) pbf.writePackedVarint(3, obj.vals)
	if (obj.info) pbf.writeMessage(4, writeInfo, obj.info)
