...
describe("extract", () => {
  ...
  test("extract a BBOX after reading a PBF", async () => {
    ...
    expect(Array.from(streaming.nodes.ids.sorted)).toEqual(Array.from(twoStep.nodes.ids.sorted));
    expect(Array.from(streaming.ways.ids.sorted)).toEqual(Array.from(twoStep.ways.ids.sorted));
  ...
  test("smart strategy retains node members of relations", () => {
    ...
    expect(simpleRelation!.members.some((m) => m.type === "node" && m.ref === 1)).toBe(true);
    expect(simpleRelation!.members.some((m) => m.type === "way" && m.ref === 10)).toBe(true);
    ...
    expect(completeRelation!.members.some((m) => m.type === "node" && m.ref === 1)).toBe(true);
    expect(completeRelation!.members.some((m) => m.type === "way" && m.ref === 10)).toBe(true);
    ...
    expect(smartRelation!.members.some((m) => m.type === "node" && m.ref === 1)).toBe(true);
    expect(smartRelation!.members.some((m) => m.type === "node" && m.ref === 2)).toBe(true);
    expect(smartRelation!.members.some((m) => m.type === "way" && m.ref === 10)).toBe(true);
  ...
  test("smart strategy resolves multipolygon nested relation members", () => {
    ...
    expect(simpleRelation200!.members.some((m) => m.type === "node" && m.ref === 3)).toBe(false);
    expect(completeRelation200!.members.some((m) => m.type === "node" && m.ref === 3)).toBe(false);
    expect(smartRelation200!.members.some((m) => m.type === "node" && m.ref === 3)).toBe(true);
    ...
    expect(simpleRelation300!.members.some((m) => m.type === "node" && m.ref === 4)).toBe(false);
    expect(completeRelation300!.members.some((m) => m.type === "node" && m.ref === 4)).toBe(false);
    expect(simpleRelation300!.members.some((m) => m.type === "relation" && m.ref === 200)).toBe(
      true,
    );
    expect(completeRelation300!.members.some((m) => m.type === "relation" && m.ref === 200)).toBe(
      true,
    );
    expect(smartRelation300!.members.some((m) => m.type === "relation" && m.ref === 200)).toBe(
      true,
    );
    expect(smartRelation300!.members.some((m) => m.type === "node" && m.ref === 4)).toBe(false);
  ...
  test("smart strategy does not extend non-multipolygon relations", () => {
    ...
    expect(smartRelation!.members.some((m) => m.type === "node" && m.ref === 2)).toBe(false);
    expect(simpleRelation!.members.some((m) => m.type === "node" && m.ref === 2)).toBe(false);
    expect(completeRelation!.members.some((m) => m.type === "node" && m.ref === 2)).toBe(false);
