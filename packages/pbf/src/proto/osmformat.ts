 ...
 */
export function readHeaderBlock(
	pbf: PbfReader,
	end?: number,
): OsmPbfHeaderBlock {
 ...
 */
function readHeaderBlockField(
	tag: number,
	obj: OsmPbfHeaderBlock,
	pbf: PbfReader,
) {
 ...
 */
function readHeaderBBoxField(
	tag: number,
	obj: OsmPbfHeaderBBox,
	pbf: PbfReader,
) {
 ...
 */
function readDenseNodesField(
	tag: number,
	obj: OsmPbfDenseNodes,
	pbf: PbfReader,
) {
