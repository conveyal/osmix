 ...
 */
export function readHeaderBlock(pbf: PbfReader, end?: number): OsmPbfHeaderBlock {
 ...
 */
function readHeaderBlockField(tag: number, obj: OsmPbfHeaderBlock, pbf: PbfReader) {
 ...
 */
export function writeHeaderBlock(obj: OsmPbfHeaderBlock, pbf: PbfWriter) {
 ...
 */
function readHeaderBBox(pbf: PbfReader, end?: number): OsmPbfHeaderBBox {
 ...
 */
function readHeaderBBoxField(tag: number, obj: OsmPbfHeaderBBox, pbf: PbfReader) {
 ...
 */
function writeHeaderBBox(obj: OsmPbfHeaderBBox, pbf: PbfWriter) {
 ...
 */
export function readPrimitiveBlock(pbf: PbfReader, end?: number): OsmPbfBlock {
  return pbf.readFields(
 ...
 */
function readPrimitiveBlockField(tag: number, obj: OsmPbfBlock, pbf: PbfReader) {
  if (tag === 1) {
 ...
 */
export function writePrimitiveBlock(obj: OsmPbfBlock, pbf: PbfWriter) {
 ...
 */
function readPrimitiveGroup(pbf: PbfReader, end?: number): OsmPbfGroup {
 ...
 */
function readPrimitiveGroupField(tag: number, obj: OsmPbfGroup, pbf: PbfReader) {
 ...
 */
function writePrimitiveGroup(obj: OsmPbfGroup, pbf: PbfWriter) {
  if (obj.nodes) {
 ...
 */
function readStringTable(pbf: PbfReader, end?: number): OsmPbfStringTable {
  return pbf.readFields(readStringTableField, [], end);
}
/**
 * Appends string table entries as they are encountered.
 */
function readStringTableField(tag: number, obj: Uint8Array[], pbf: PbfReader) {
  if (tag === 1) obj.push(pbf.readBytes());
}
/**
 * Serializes string table entries.
 */
function writeStringTable(obj: OsmPbfStringTable, pbf: PbfWriter) {
  if (obj) {
 ...
 */
function readInfo(pbf: PbfReader, end?: number): OsmPbfInfo {
  return pbf.readFields(readInfoField, {}, end);
}
/**
 * Populates primitive metadata fields.
 */
function readInfoField(tag: number, obj: OsmPbfInfo, pbf: PbfReader) {
 ...
 */
function writeInfo(obj: OsmPbfInfo, pbf: PbfWriter) {
 ...
 */
function readDenseInfo(pbf: PbfReader, end?: number): OsmPbfDenseInfo {
  return pbf.readFields(
    readDenseInfoField,
    {
      version: [],
 ...
 */
function readDenseInfoField(tag: number, obj: OsmPbfDenseInfo, pbf: PbfReader) {
 ...
 */
function writeDenseInfo(obj: OsmPbfDenseInfo, pbf: PbfWriter) {
 ...
 */
function readNode(pbf: PbfReader, end?: number): OsmPbfNode {
  return pbf.readFields(readNodeField, { id: 0, keys: [], vals: [], lat: 0, lon: 0 }, end);
}
/**
 * Populates node fields based on protobuf tags.
 */
function readNodeField(tag: number, obj: OsmPbfNode, pbf: PbfReader) {
 ...
 */
function writeNode(obj: OsmPbfNode, pbf: PbfWriter) {
 ...
 */
function readDenseNodes(pbf: PbfReader, end?: number): OsmPbfDenseNodes {
  return pbf.readFields(readDenseNodesField, { id: [], lat: [], lon: [], keys_vals: [] }, end);
}
/**
 * Populates dense node arrays using packed encoding.
 */
function readDenseNodesField(tag: number, obj: OsmPbfDenseNodes, pbf: PbfReader) {
 ...
 */
function writeDenseNodes(obj: OsmPbfDenseNodes, pbf: PbfWriter) {
 ...
 */
function readWay(pbf: PbfReader, end?: number): OsmPbfWay {
  return pbf.readFields(
    readWayField,
 ...
 */
function readWayField(tag: number, obj: OsmPbfWay, pbf: PbfReader) {
 ...
 */
function writeWay(obj: OsmPbfWay, pbf: PbfWriter) {
 ...
 */
function readRelation(pbf: PbfReader, end?: number): OsmPbfRelation {
  return pbf.readFields(
    readRelationField,
    {
      id: 0,
 ...
 */
function readRelationField(tag: number, obj: OsmPbfRelation, pbf: PbfReader) {
  if (tag === 1) obj.id = pbf.readVarint(true);
  else if (tag === 2) pbf.readPackedVarint(obj.keys);
  else if (tag === 3) pbf.readPackedVarint(obj.vals);
  else if (tag === 4) obj.info = readInfo(pbf, pbf.readVarint() + pbf.pos);
 ...
 */
function writeRelation(obj: OsmPbfRelation, pbf: PbfWriter) {
  if (obj.id) pbf.writeVarintField(1, obj.id);
  if (obj.keys) pbf.writePackedVarint(2, obj.keys);
  if (obj.vals) pbf.writePackedVarint(3, obj.vals);
  if (obj.info) pbf.writeMessage(4, writeInfo, obj.info);
